...
public struct UIElements
{
   ...
   // public Image Lines { get { return lines; } }
    ...
    [SerializeField] CanvasGroup notesCanvasGroup ;
    public CanvasGroup NotesCanvasGroup { get { return notesCanvasGroup; } }
   ...
   public NoteData NoteDataPrefab { get { return noteDataPrefab; } }
    ...
    [SerializeField] CanvasGroup uiRootCanvasGroup;
    public CanvasGroup UIRootCanvasGroup { get { return uiRootCanvasGroup; } }// drag your UI Root here
...
public class NotesSystem : MonoBehaviour
{
    ...
    [Space]
    [SerializeField] private AudioClip openAudioSFX = null;
    [SerializeField] private AudioClip closeAudioSFX = null;
    [Space]
...
#region Unity's Default method's
    ...
    public void CloseNote(bool playSFX)
    {
        if (playSFX)
        {
            PlaySound(closeAudioSFX);  //closeNoteSFX
        }

        UpdateCanvasGroup(false, UI.NotesCanvasGroup);
        OnNoteClose();
    }

    [SerializeField] private StarterAssetsInputs playerInput;
    [SerializeField] private ThirdPersonController playerController;
    public void Open() //disabling game controller
    {
    ...
    private void SwitchGameControls(bool state)
    {
        ...
        switch (state)
        {
            case true:
                ...
                UI.UIRootCanvasGroup.blocksRaycasts = true;
                break;
            case false:
                ...
                Cursor.visible = true;
                Cursor.lockState = CursorLockMode.None;
                UI.UIRootCanvasGroup.blocksRaycasts = false;
                break;
    ...
    private void DisplayNote(Note note)
    {
        ...
        PlaySound(openAudioSFX); //openNoteSFX

        UpdateCanvasGroup(true, UI.NotesCanvasGroup);
        activeNote = note;
